...
def init():
    ...
    if not pro_status:
        ...
        pro_status3 = ProStatus(name='遗留')
        pro_status4 = ProStatus(name='待排期')
        pro_status5 = ProStatus(name='开发中')
        pro_status6 = ProStatus(name='测试中')
        pro_status7 = ProStatus(name='已上线')
        pro_status8 = ProStatus(name='已暂停')
